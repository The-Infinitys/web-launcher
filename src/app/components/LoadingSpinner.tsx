...
import styles from "./LoadingSpinner/style.module.css";
  ...
  return (
    <div className={styles.overlay}>
      <div className={styles.spinner}>
        {/* SVG content from public/next-loading.svg */}
        <svg
          viewBox="0 0 120 60"
          version="1.1"
